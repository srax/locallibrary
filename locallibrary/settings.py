...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-g0sm2%+-kjd*)2t1$k9dbw15@406t2)6&me+d&)jx9pr_&_+$q')
...
MIDDLEWARE = [
    ...
    'django.middleware.locale.LocaleMiddleware', # Detects the users language preference
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'catalog.context_processors.user_context',
            ],
        },
    },
]
